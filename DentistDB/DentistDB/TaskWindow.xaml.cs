    ...
    public partial class TaskWindow : Window
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    if (t.DoctorId == null | t.DoctorId == 0)
                    {
                ...
                if (t.Id > 0)
                {
                    ...
                    try
                    {
                        ...
                        using (var con = new MySqlConnection("server=45.84.206.101;user=u158550680_Eddy;persistsecurityinfo=True;database=u158550680_dentist_db;password=Eddy8479;allowuservariables=True"))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@diag", t.Diagnose);
        ...
        {
            MessageBoxResult res = MessageBox.Show("Потвърдете плащането на сумата!", "Плащане", MessageBoxButton.YesNo);
            if (res != null)
            {
