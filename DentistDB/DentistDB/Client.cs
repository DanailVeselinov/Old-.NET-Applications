...
namespace DentistDB
{
    ...
    public partial class ClientListed
    {
        public int Id { get; set; }
        public string FirstName { get; set; }
        public string SecondName { get; set; }
        ...
        public ClientListed(int id, string fname, string sname, string lname,string pn, string ti, string ph1, string ph2, string email, DateTime ldate) 
        {
            Id = id;
            FirstName = fname;
            SecondName = sname;
            ...
            Phone2 = ph2;
            Email = email;
            LastDateUpdate = ldate;
        }
    }
    public partial class ClientListed1
    {
        public int Id { get; set; }
        public string FirstName { get; set; }
        public string SecondName { get; set; }
