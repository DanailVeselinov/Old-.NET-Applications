...
namespace NewsToEmailWebApp.Account
{
    ...
    {        
        ...
        protected void ForgotPassword_Click(object sender, EventArgs e)
        {
            ...
            var reqUName = SiteMaster.FindControlRecursive(Page,"RequiredFieldValidatorUserName") as RequiredFieldValidator;
            ...
            else
            {
                ...
                if (user != null)
                {
                    ...
                    {
                        var fText = SiteMaster.FindControlRecursive(Page, "FailureText") as Literal;
