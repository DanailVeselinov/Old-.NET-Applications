...
<asp:Content ID="EditFilters" ContentPlaceHolderID="MainContent" runat="server">
    <asp:EntityDataSource ID="EntityDataSourceFilters" runat="server" ConnectionString="name=Entities" DefaultContainerName="Entities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="FiltersCategories" EntityTypeFilter="FiltersCategories" AutoGenerateWhereClause="True" Where="">
            <WhereParameters>
    ...
    <div>
        ...
        <asp:Panel CssClass="float-left-inline" ID="Panel3" runat="server" HorizontalAlign="Left" Width="250px" Height="500px"
            ...
            <div style="display:inline-block; vertical-align:top;">
                ...
                <asp:GridView runat="server" ID="FiltersGridView" DataSourceID="EntityDataSourceFilters" AutoGenerateColumns="false" DataKeyNames="id" AllowSorting="True" CellPadding="4" ForeColor="#333333" GridLines="None">
