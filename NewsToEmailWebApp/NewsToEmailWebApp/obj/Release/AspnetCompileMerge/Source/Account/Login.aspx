        ...
        <asp:Login runat="server" ViewStateMode="Disabled" RenderOuterTable="false" ClientIDMode="Static" ID="LoginView">
            <LayoutTemplate>
                ...
                <fieldset>
                    ...
                    <asp:LinkButton runat="server" TabIndex="200" style="display:block; margin-top:-25px;" OnClick="ForgotPassword_Click" CausesValidation="false" ID="ForgotPassowrdLB" Text="I Forgot my password!"></asp:LinkButton>
