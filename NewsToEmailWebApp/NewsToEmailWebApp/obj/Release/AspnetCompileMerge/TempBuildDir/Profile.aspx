...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div style="display:block">
        <div style="display:inline; float:left; vertical-align:top;max-width:70%; min-width:100px">
            <div>
            ...
            <div id="CreateUserTable" runat="server">
                ...
                <asp:Panel style="display:inline-block; vertical-align:top;" ID="Panel1" runat="server"  Font-Size="Large" HorizontalAlign="Center">
                    ...
                    <asp:TextBox runat="server" ID="limitTB" TextMode="Number" ToolTip="Enter the maximum size of an e-mail. Some e-mail providers has less limit of an e-mail. So if you don't recieve news it's probbably the reason why. Just enter some limit eg. 200KB"></asp:TextBox>
                    ...
                    <asp:RangeValidator ID="SizeLimitRangeValidator" runat="server" MinimumValue="0" MaximumValue="50000" Type="Integer" ControlToValidate="limitTB"
                        ...
                        <ItemTemplate>                            
                            <td style="padding-bottom:10px;" title="This is a web-site slot, where you can select or add the desired news web-site. You can have more than one slot respectively recieve news from more than one web-site just contact us.">                                    
                                <asp:Panel ID="FullSlot" runat="server" HorizontalAlign="Center" style="border:solid; border-width:5px; border-color:lightslategrey; border-radius:12px; padding:10px;">                                        
                                    ...
                                    <asp:Label ID="LastSendDate" style="display:block; margin-bottom:3px" runat="server">Last Send Date:<%#(GetDataItem() as NewsToEmailWebApp.UsersWebsites).lastSendDate.Value.ToShortDateString()%></asp:Label>
                                </asp:Panel>
                            </td>
            ...
            <div style="display:inline; float:left; vertical-align:top; max-width:24%;">
